...
$getdata->my_sql_set_utf8();
	...
	switch(addslashes($_GET['type'])){
		...
		case "change_products_status" : if(addslashes($_GET['sts']) == "1"){
											$getdata->my_sql_update("product","ProductStatus='0'","ProductID='".addslashes($_GET['key'])."'");
										}else{
											$getdata->my_sql_update("product","ProductStatus='1'","ProductID='".addslashes($_GET['key'])."'");
										}

		break;
		case "change_products_status_N" : if(addslashes($_GET['sts']) == "1"){
											$getdata->my_sql_update("product_N","ProductStatus='0'","ProductID='".addslashes($_GET['key'])."'");
										}else{
											$getdata->my_sql_update("product_N","ProductStatus='1'","ProductID='".addslashes($_GET['key'])."'");
										}
...
break;
		case "change_type_status" : if(addslashes($_GET['sts']) == "1"){
											...
											$getdata->my_sql_update("type","TypeStatus='1'","TypeID='".addslashes($_GET['key'])."'");
										}
    ...
    break;
		...
		break;
		case "delete_cardtype" : $getdata->my_sql_update("type","TypeStatus='2'","TypeID='".addslashes($_GET['key'])."'");
		break;
		case "delete_brand" : $getdata->my_sql_update("brand","BrandStatus='2'","BrandID='".addslashes($_GET['key'])."'");
		break;
		...
		break;
		case "delete_item" : $getdata->my_sql_delete("reserve_item","item_key='".addslashes($_GET['key'])."'");
		break;
		case "delete_card_item" : $getdata->my_sql_delete("card_item","item_key='".addslashes($_GET['key'])."'");
		break;
		...
		case "delete_products" : $getdata->my_sql_delete("product_n","ProductID='".addslashes($_GET['key'])."'");
		break;
		case "delete_stock" :
	...
	case "show_card_count" : $card_count = $getdata->my_sql_show_rows("card_info","card_status <> '' AND card_status <> 'hidden'");
		...
		break;
	case "delete_dealer" : $getdata->my_sql_update("dealer","status=0","dealer_id='".addslashes($_GET['key'])."'");
