...
if(isset($_POST['save_card'])){
    ...
    if(mysql_num_rows($chk_DiameterWhee) < 1){
      $getdata->my_sql_insert_New(" RimWheel "," code , Description, status "," '".addslashes($_POST['code'])."' , '".addslashes($_POST['shelf_detail'])."' ,'".addslashes($_POST['shelf_status'])."' ");
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <?php
                                          @$getcode = $getdata->getMaxID_N("code","RimWheel","WR");
                                          ?>
