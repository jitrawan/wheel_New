...
<?
  $getporduct = $getdata->my_sql_select(NULL,"Event_Item"," Event_Code='".$_GET['d']."' and ProductID='".$_POST['ProductID']."'");
    if(mysql_num_rows($getporduct) < 1){
       $getdata->my_sql_insert_New("Event_Item","Event_Code, ProductID
          , PriceSale, item_amt "
          ," '".$_GET['d']."'
...
<?
if($_GET['proId'] != ""){
  $gettype = $getdata->my_sql_select("TypeID,ProductID","product_N","ProductID='".$_GET['proId']."'");
                             ...
                             <div class="form-group">
                               ...
                               <div class="form-group row">
                                  <div class="col-xs-3">
                                              ...
                                              <input class="form-control" type="text" name="ProductID" id="ProductID" value="<?= @$getfont->ProductID?>" readonly>
                                  </div>
                                  <div class="col-xs-8">
