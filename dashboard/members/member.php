...
if(isset($_POST['save_member'])){
    ...
    $getdata->my_sql_insert_New("dealer","dealer_code , dealer_name, mobile, address, idline, email, status"," '".addslashes($_POST['dealer_code'])."' , '".addslashes($_POST['dealer_name'])."' , '".addslashes($_POST['mobile'])."' , '".addslashes($_POST['address'])."' , '".addslashes($_POST['idline'])."' , '".addslashes($_POST['email'])."',1 ");
